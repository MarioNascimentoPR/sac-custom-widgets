(function () {
  ...
  template.innerHTML = `
    <style>
      ...
      /* Aumentado o topo para dar respiro ao teto da linha */
      ...
      /* BAR WRAPPERS E BARRAS - Z-INDEX: 2 (Ficam na frente do SVG) */
      ...
      /* KPI LABEL - MÁSCARA MÁGICA: Fundo branco para cobrir a linha que passa atrás, Z-INDEX 3 */
      .kpi-label { 
